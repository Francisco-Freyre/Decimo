...
@class XF_Material_iOS_Renderers_MaterialCardRenderer;
@class Lottie_Forms_Platforms_Ios_AnimationViewRenderer;
@class XF_Material_iOS_Renderers_MaterialCircularLoadingViewRenderer;
@class XF_Material_iOS_Renderers_MaterialDatePickerRenderer;
@class XF_Material_iOS_Renderers_MaterialLabelRenderer;
@class XF_Material_iOS_Renderers_MaterialMenuRenderer;
@class XF_Material_iOS_Renderers_Internals_MaterialElementRenderer;
@class XF_Material_iOS_Renderers_Internals_MaterialEntryRenderer;
@class XF_Material_iOS_GestureRecognizers_MaterialRippleGestureRecognizer;
@class XF_Material_iOS_Delegates_MaterialRippleGestureRecognizerDelegate;
@class XF_Material_iOS_Renderers_MaterialButtonRenderer;
@class XF_Material_iOS_Renderers_MaterialIconRenderer;
@class XF_Material_iOS_Renderers_MaterialNavigationPageRenderer_NavigationControllerDelegate;
@class XF_Material_iOS_Renderers_MaterialNavigationPageRenderer;
@class XF_Material_iOS_Renderers_Internals_MaterialBoxViewRenderer_BoxViewGestureRecognizerDelegate;
@class XF_Material_iOS_Renderers_Internals_MaterialBoxViewRenderer;
...
@interface XF_Material_iOS_Renderers_MaterialCardRenderer : Xamarin_Forms_Platform_iOS_FrameRenderer {
}
	-(id) init;
@end
...
@interface XF_Material_iOS_Renderers_MaterialCircularLoadingViewRenderer : Lottie_Forms_Platforms_Ios_AnimationViewRenderer {
}
	-(void) layoutSubviews;
	-(id) init;
@end

@interface XF_Material_iOS_Renderers_MaterialDatePickerRenderer : Xamarin_Forms_Platform_iOS_DatePickerRenderer {
}
	-(id) init;
@end

@interface XF_Material_iOS_Renderers_MaterialLabelRenderer : Xamarin_Forms_Platform_iOS_LabelRenderer {
}
	-(void) layoutSubviews;
	-(id) init;
@end

@interface XF_Material_iOS_Renderers_MaterialMenuRenderer : Xamarin_Forms_Platform_iOS_VisualElementRenderer_1 {
}
	-(id) init;
@end

@interface XF_Material_iOS_Renderers_Internals_MaterialEntryRenderer : Xamarin_Forms_Platform_iOS_EntryRenderer {
}
	-(id) init;
@end

@interface XF_Material_iOS_GestureRecognizers_MaterialRippleGestureRecognizer : UITapGestureRecognizer<UIGestureRecognizerDelegate> {
}
	-(void) release;
	-(id) retain;
	-(GCHandle) xamarinGetGCHandle;
...
@interface XF_Material_iOS_Delegates_MaterialRippleGestureRecognizerDelegate : NSObject<UIGestureRecognizerDelegate> {
}
	-(void) release;
	-(id) retain;
	-(GCHandle) xamarinGetGCHandle;
...
@interface XF_Material_iOS_Renderers_MaterialButtonRenderer : Xamarin_Forms_Platform_iOS_ButtonRenderer {
}
	-(void) layoutSubviews;
	-(id) init;
@end

@interface XF_Material_iOS_Renderers_MaterialIconRenderer : Xamarin_Forms_Platform_iOS_ImageRenderer {
}
	-(id) init;
@end

@interface XF_Material_iOS_Renderers_MaterialNavigationPageRenderer : Xamarin_Forms_Platform_iOS_NavigationRenderer {
}
	-(NSArray *) popToRootViewControllerAnimated:(BOOL)p0;
	-(UIViewController *) popViewControllerAnimated:(BOOL)p0;
	-(id) init;
