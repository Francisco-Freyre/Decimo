...
extern void *mono_aot_module_vinoCal_iOS_info;
...
extern void *mono_aot_module_vinoCal_info;
extern void *mono_aot_module_Xamarin_Forms_Xaml_info;
extern void *mono_aot_module_XF_Material_info;
...
{
	mono_aot_register_module (mono_aot_module_vinoCal_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_vinoCal_info);
	mono_aot_register_module (mono_aot_module_Xamarin_Forms_Xaml_info);
	mono_aot_register_module (mono_aot_module_XF_Material_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "vinoCal.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
